package fun.pullock.groovy.dao;
...
public class BizDao {
    ...
    public String getGroovyClassLoaderContentFromDB() {
        return "package fun.pullock.groovy\n" +
                "\n" +
                "import engine.groovy.fun.pullock.AbstractBizScriptProcessor\n" +
                "\n" +
    ...
    public ScriptDO queryScript2() {
        ...
        scriptDO.setExecuteMode(new Random().nextInt(3));
        scriptDO.setContent("package fun.pullock.groovy.scripts\n" +
                "\n" +
                "import groovy.json.JsonOutput\n" +
                "import groovy.json.JsonSlurper\n" +
                "import groovy.transform.EqualsAndHashCode\n" +
                "import engine.groovy.fun.pullock.AbstractResultCalculator\n" +
                "import engine.groovy.fun.pullock.ScriptContext\n" +
                "\n" +
