...
class CVDScript extends fun.pullock.groovy.engine.AbstractResultCalculator {
    ...
    static void main(String[] args) {
        ...
        def result = new CVDScript().calculate(new fun.pullock.groovy.engine.ScriptContext(bizResultId: 1 as long, param: JsonOutput.toJson(map)))
        println(result)
    }
}
