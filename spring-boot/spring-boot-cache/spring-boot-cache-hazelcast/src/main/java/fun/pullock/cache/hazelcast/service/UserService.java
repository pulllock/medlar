package fun.pullock.cache.hazelcast.service;

import jakarta.annotation.Resource;
import fun.pullock.cache.hazelcast.cache.CacheNames;
import fun.pullock.cache.hazelcast.dao.UserDao;
import fun.pullock.cache.hazelcast.dao.model.UserDO;
import fun.pullock.cache.hazelcast.model.User;
