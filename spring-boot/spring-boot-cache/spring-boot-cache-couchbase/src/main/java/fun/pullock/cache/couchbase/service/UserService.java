package fun.pullock.cache.couchbase.service;

import fun.pullock.cache.couchbase.cache.CacheNames;
import fun.pullock.cache.couchbase.dao.UserDao;
import fun.pullock.cache.couchbase.dao.model.UserDO;
import fun.pullock.cache.couchbase.model.User;
