...
import fun.pullock.redis.constants.RedisKeys;
import fun.pullock.redis.RedisClient;
...
public class RankService {
    ...
    public boolean addFriend() {
        Long userId = 1L;
        String key = RedisKeys.friendRelationPrefix + userId;
    ...
    public boolean addSteps(Long userId, long steps) {
        String key = RedisKeys.userStepsPrefix + userId;
