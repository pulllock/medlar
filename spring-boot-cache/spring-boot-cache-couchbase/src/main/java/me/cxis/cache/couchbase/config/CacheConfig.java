package me.cxis.cache.couchbase.config;
...
import static me.cxis.cache.couchbase.constants.DateTimeFormatConstant.*;
...
public class CacheConfig {
    ...
    public CouchbaseCacheManagerBuilderCustomizer couchbaseCacheManagerBuilderCustomizer() {
        return builder -> builder
                ...
                .withCacheConfiguration(USER_BY_ID, couchbaseCacheConfiguration().entryExpiry(Duration.ofMinutes(1)))
                .withCacheConfiguration(USER_BY_NAME, couchbaseCacheConfiguration().entryExpiry(Duration.ofMinutes(2)))
                ;
    }
